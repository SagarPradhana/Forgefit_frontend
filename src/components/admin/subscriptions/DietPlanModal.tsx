          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div className="flex flex-col gap-1">
                <h3 className="text-sm font-black text-white uppercase tracking-widest">{t("nutritionalCycles")}</h3>
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-tight">{t("defineMacros")}</p>
              </div>
              <button
                onClick={() => setDietForm({
                  ...dietForm,
                    ...
                    <div className="grid gap-2">
                        ...
                        <div key={fIndex} className="flex gap-2 items-center bg-slate-950/80 p-3 rounded-xl border border-white/5 group/row hover:border-emerald-500/20 transition-all">
                          <div className="flex-1 grid grid-cols-2 gap-3">
                            <div className="space-y-1">
                              <span className="text-[9px] font-black text-slate-600 uppercase tracking-wider ml-1">{t("ingredientMeal")}</span>
                              <input
                      ...
                      {dayDetail.foods.length === 0 && (
                        <div className="text-center py-6 bg-slate-950/50 rounded-xl border border-white/5 border-dashed">
                          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">{t("noMealsDefined")}</p>
                        </div>
                      )}
                    </div>
                  </div>
